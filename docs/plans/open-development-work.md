...
| Background running | Testing / in progress | Validate Phases 0-3 on real platforms, add Android foreground handling for large transfers, then implement power controls, retained progress, and platform hardening. | [Background Running Plan](./background-running-plan.md) |
...
5. Add Android foreground transfer handling and Phase 4 power controls.
