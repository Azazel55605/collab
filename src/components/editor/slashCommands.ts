  ...
  return [
    {
      ...
      type: 'text',
      keywords: ['h1 title'],
      apply: (view) => insertSnippetTemplate(view, '# <placeholder:Heading>\n<cursor>'),
    },
    {
      label: 'Heading 2',
    ...
    {
      label: 'Bullet List',
      detail: 'Unordered list starter',
      type: 'text',
      keywords: ['list bullets'],
      apply: (view) => insertSnippetTemplate(view, '- <placeholder:List item>\n<cursor>'),
    },
    {
      label: 'Ordered List',
      detail: 'Numbered list starter',
      type: 'text',
      keywords: ['list numbered'],
      apply: (view) => insertSnippetTemplate(view, '1. <placeholder:List item>\n<cursor>'),
    },
    {
      label: 'Task List',
      detail: 'Checklist starter',
      type: 'text',
      keywords: ['tasks checklist'],
      apply: (view) => insertSnippetTemplate(view, '- [ ] <placeholder:Task>\n<cursor>'),
    },
    {
      label: 'Blockquote',
      detail: 'Quoted block',
      type: 'text',
      keywords: ['quote'],
      apply: (view) => insertSnippetTemplate(view, '> <placeholder:Quoted text>\n<cursor>'),
    },
    {
      label: 'Divider',
      detail: 'Horizontal rule',
      type: 'text',
      keywords: ['separator hr rule'],
      apply: (view) => insertSnippetTemplate(view, '\n---\n<cursor>'),
    },
    {
      label: 'Table',
      detail: 'Basic 3-column table',
      type: 'text',
      keywords: ['grid table'],
      apply: (view) =>
        insertSnippetTemplate(
          view,
          '| <placeholder:Column 1> | <placeholder:Column 2> | <placeholder:Column 3> |\n| --- | --- | --- |\n| <placeholder:Value 1> | <placeholder:Value 2> | <placeholder:Value 3> |\n<cursor>',
        ),
    },
    {
      label: 'Code Block',
      ...
      apply: (view) =>
        insertSnippetTemplate(view, '```<placeholder:language>\n<placeholder:code>\n```\n<cursor>'),
    },
    {
      label: 'Math Block',
    ...
    },
    {
      ...
      apply: (view) =>
        insertSnippetTemplate(
          view,
          '[<placeholder:link text>](<placeholder:https://example.com>)<cursor>',
        ),
    },
    {
      label: 'Image',
      ...
      apply: (view) =>
        insertSnippetTemplate(
          view,
          '![<placeholder:alt text>](<placeholder:Pictures/example.png>)<cursor>',
        ),
    },
    {
      label: 'Callout: Note',
      detail: 'Styled note callout',
      type: 'text',
      keywords: ['admonition note'],
      apply: (view) => insertSnippetTemplate(view, buildCalloutSnippet('note')),
    },
    {
      label: 'Callout: Tip',
      detail: 'Styled tip callout',
      type: 'text',
      keywords: ['admonition tip'],
      apply: (view) => insertSnippetTemplate(view, buildCalloutSnippet('tip')),
    },
    {
      label: 'Callout: Warning',
      detail: 'Styled warning callout',
      type: 'text',
      keywords: ['admonition warning'],
      apply: (view) => insertSnippetTemplate(view, buildCalloutSnippet('warning')),
    },
    {
      label: 'Callout: Danger',
      detail: 'Styled danger callout',
      type: 'text',
      keywords: ['admonition danger'],
      apply: (view) => insertSnippetTemplate(view, buildCalloutSnippet('danger')),
    },
    {
      label: 'Callout: Info',
      detail: 'Styled info callout',
      type: 'text',
      keywords: ['admonition info'],
      apply: (view) => insertSnippetTemplate(view, buildCalloutSnippet('info')),
    },
    {
      label: 'Footnote',
      detail: 'Insert or jump to a footnote',
      type: 'text',
      keywords: ['citation note reference'],
      apply: (view) => {
        void insertOrNavigateFootnote(view);
      },
    },
    {
      label: 'References Section',
      detail: 'Simple references scaffold',
      type: 'text',
      keywords: ['citation bibliography sources'],
      apply: (view) => insertSnippetTemplate(view, buildReferencesSectionSnippet()),
    },
    {
      label: 'Logic Diagram',
      detail: 'Link to a .logic diagram export',
      type: 'text',
      keywords: ['circuit gate logic diagram'],
      apply: (view) =>
        insertSnippetTemplate(
          view,
          '![<placeholder:Diagram>](<placeholder:Pictures/diagram.svg>)<cursor>',
        ),
    },
  ];
}
...
function snippetToCommand(snippet: NoteSnippet): SlashCommandItem {
  return {
    ...
    detail:
      snippet.description ??
      snippet.category ??
      (snippet.scope === 'vault' ? 'Vault snippet' : 'App snippet'),
    type: 'text',
