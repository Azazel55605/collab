...
| Mobile widgets | Phase 1 testing | Validate the implemented native snapshot/configuration foundation on a physical smartphone, then deliver the Phase 2 calendar agenda data path; Phase 0 is complete. | [Mobile Widgets Integration Plan](./mobile-widgets-plan.md) |
