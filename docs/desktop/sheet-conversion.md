...
| Stored error values (`#REF!`, `#DIV/0!`, …) | Imported as text; Collab only produces error *values* from its own evaluation |
...
the file displays it instead of executing it. Writing formula *source* instead
