...
| Background running | Testing / in progress | Validate the Phase 0 WorkManager proof, Phase 1 headless coordinator, and completed Phase 2 desktop tray/autostart lifecycle on real platforms, then add Android scheduling, power controls, and platform QA. | [Background Running Plan](./background-running-plan.md) |
...
2. Validate the Phase 0 desktop tray and Android WorkManager probes on real
   target platforms.
