...
describe('useCardDialogChecklistComments helpers', () => {
  ...
  it('adds, toggles, updates, and removes checklist entries', () => {
    ...
    expect(toggleChecklistEntry(added, '00000000-0000-0000-0000-000000000001')[0].checked).toBe(
      true,
    );
    expect(
      updateChecklistEntryText(added, '00000000-0000-0000-0000-000000000001', 'Updated')[0].text,
    ).toBe('Updated');
  ...
  it('adds and removes comments and resolves linked card titles', () => {
    const comments = addCardComment([], ' Hello ', {
      userId: 'u1',
      userName: 'User',
      userColor: '#fff',
    });
...
describe('useCardDialogChecklistComments', () => {
  ...
  it('updates checklist and comment state through patchDraft', () => {
    ...
    expect(patchDraft).toHaveBeenCalledWith({
      checklist: [
        expect.objectContaining({ id: '00000000-0000-0000-0000-000000000001', text: 'Task' }),
      ],
    });
    ...
    expect(patchDraft).toHaveBeenCalledWith({
      comments: [
        expect.objectContaining({ id: '00000000-0000-0000-0000-000000000001', content: 'Hello' }),
      ],
    });
  });
});
