...
| Digital ink and annotation       | Phase 7 complete                 | Phases 0-7 are implemented and physically validated, including hosted/offline collaboration plus deterministic PNG/SVG/PDF export and source-linked note embeds. Start Phase 8 PDF annotation integration.              | [Digital Ink And Annotation Plan](./digital-ink-and-annotation-plan.md), [Phase 0 Contract](./digital-ink-phase0-contract.md) |
