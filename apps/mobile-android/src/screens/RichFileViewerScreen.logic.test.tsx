...
vi.mock('../mobileTauri', () => ({
  ...
  listProfileCalendarMirrorGroups: vi.fn(),
  listProfileCalendarMirrorAnchors: vi.fn(),
  listProfileCalendarMirrorConflicts: vi.fn(),
  listProfileCalendarMirrorItems: vi.fn(),
  saveProfileCalendarMirrorAnchors: vi.fn(),
  saveProfileCalendarMirrorConflict: vi.fn(),
  upsertProfileCalendarItem: vi.fn(),
  deleteProfileCalendarItem: vi.fn(),
