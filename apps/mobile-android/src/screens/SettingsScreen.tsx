            ...
            <div className="segmented-control calendar-duration-options">
              {(
                ...
                <button
                  ...
                  disabled={
                    !background.runInBackground || !background.backgroundSync || backgroundBusy
                  }
        ...
        <section className="card">
          ...
          <div className="setting-row">
            <div>
              ...
              <span>Read from this device.</span>
            </div>
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Used for calendar dates across the app.</span>
            </div>
            <div className="segmented-control calendar-date-options">
              {(
                ...
                <button
                  key={value}
                  type="button"
                  className={prefs.calendarDateFormat === value ? 'selected' : ''}
                  onClick={() => onChange({ ...prefs, calendarDateFormat: value })}
                >
                  {label}
                </button>
              ))}
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Used by calendar labels and time controls.</span>
            </div>
            <div className="segmented-control">
              {(
                ...
                <button
                  key={value}
                  type="button"
                  className={prefs.calendarTimeFormat === value ? 'selected' : ''}
                  onClick={() => onChange({ ...prefs, calendarTimeFormat: value })}
                >
                  {label}
                </button>
              ))}
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Controls the first Month column.</span>
            </div>
            <div className="segmented-control">
              <button
                type="button"
                className={prefs.calendarWeekStart === 1 ? 'selected' : ''}
                onClick={() => onChange({ ...prefs, calendarWeekStart: 1 })}
              >
                Monday
              </button>
              <button
                type="button"
                className={prefs.calendarWeekStart === 0 ? 'selected' : ''}
                onClick={() => onChange({ ...prefs, calendarWeekStart: 0 })}
              >
                Sunday
              </button>
            </div>
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Used when creating timed events and tasks.</span>
            </div>
            <div className="segmented-control calendar-duration-options">
              {([15, 30, 45, 60, 90, 120] as const).map((minutes) => (
                <button
                  key={minutes}
                  type="button"
                  className={prefs.calendarDefaultDurationMinutes === minutes ? 'selected' : ''}
                  onClick={() => onChange({ ...prefs, calendarDefaultDurationMinutes: minutes })}
                >
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Applied to newly created calendar items.</span>
            </div>
              ...
              {(
                ...
                const selected =
                  value === 'none'
                    ...
                    : prefs.calendarDefaultReminderMinutes === Number(value);
                return (
                  <button
                    key={value}
                    type="button"
                    ...
                    onClick={() =>
                      onChange({
                        ...prefs,
                        calendarDefaultReminderMinutes: value === 'none' ? null : Number(value),
                      })
                    }
                  >
                    {label}
          ...
          <div className="setting-row stacked">
            <div>
              ...
              <span>Used when timed schedule views open.</span>
            </div>
            <div className="calendar-working-hours">
              <div>
                ...
                <TimeField
                  ...
                  value={prefs.calendarWorkingHoursStart}
                  onChange={(calendarWorkingHoursStart) =>
                    onChange({ ...prefs, calendarWorkingHoursStart })
                  }
                />
              </div>
              <div>
                ...
                <TimeField
                  ...
                  format={prefs.calendarTimeFormat}
                  value={prefs.calendarWorkingHoursEnd}
                  onChange={(calendarWorkingHoursEnd) =>
                    onChange({ ...prefs, calendarWorkingHoursEnd })
                  }
                />
              </div>
            </div>
          ...
          <label className="toggle-row">
            <span>
              <strong>Hide weekends</strong>
              <small>Show a five-day Month layout.</small>
            </span>
            <input
              type="checkbox"
              checked={prefs.calendarHideWeekends}
              onChange={(event) =>
                onChange({ ...prefs, calendarHideWeekends: event.currentTarget.checked })
              }
            />
          </label>
          <label className="toggle-row">
            <span>
              <strong>Show declined items</strong>
              <small>Keep declined invitations visible.</small>
            </span>
            <input
              type="checkbox"
              checked={prefs.calendarShowDeclined}
              onChange={(event) =>
                onChange({ ...prefs, calendarShowDeclined: event.currentTarget.checked })
              }
            />
          </label>
        </section>
          ...
          <section className="card">
            <div className="card-title">
              <span
                ...
                style={{
                  background: `oklch(${ACCENTS.find((a) => a.id === prefs.accent)?.oklch})`,
                }}
              />
        ...
        <>
          ...
          <section className="card">
            <div className="card-title">
              <span
                className="accent-dot"
                style={{ background: 'linear-gradient(135deg, #fb7185, #facc15, #34d399)' }}
              />
            ...
            <label className="toggle-row">
              ...
              <input
                ...
                onChange={(event) =>
                  onChange({ ...prefs, showInlineColorPreviews: event.currentTarget.checked })
                }
              />
            </label>
            <label className="toggle-row disabled-when-off">
              ...
              <input
                ...
                onChange={(event) =>
                  onChange({ ...prefs, colorPreviewShowSwatch: event.currentTarget.checked })
                }
              />
            </label>
            <label className="toggle-row disabled-when-off">
              ...
              <input
                ...
                onChange={(event) =>
                  onChange({ ...prefs, colorPreviewTintText: event.currentTarget.checked })
                }
              />
            </label>
